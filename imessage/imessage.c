 ...
 * straight to the mini's iMessage agent at 192.168.1.50:2328 — no modem, no MUX
...
#define IMESSAGE_IP   "192.168.1.50"
 ...
 * socket to 192.168.1.50:2328, send the line commands (LIST/OPEN/SEND), and feed
...
static void SetDefaults(void)
{
    ...
    { const char *h = "192.168.1.50"; gCfg.host[0] = 12; for (i = 0; i < 12; i++) gCfg.host[i + 1] = (unsigned char)h[i]; }
...
/* Open a TCP socket to the mini's iMessage agent (192.168.1.50:2328) and ask for
